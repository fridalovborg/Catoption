...
function chatbubblePop(){setInterval(function(){tl.fromTo(chatbubble,.7,{alpha:0},{alpha:1,yoyo:!0,repeat:1,repeatDelay:1})},8e3)}function initMap(){map=new google.maps.Map(document.getElementById("map"),{zoom:12}),infoWindow=new google.maps.InfoWindow;var e;navigator.geolocation?navigator.geolocation.watchPosition(function(o){//getCurrentPosition
// MY POSITION COORDS
var t={lat:o.coords.latitude,lng:o.coords.longitude},n=google.maps.Animation.DROP;e?e.setPosition(t):e=new google.maps.Marker({position:t,animation:n,map:map}),
// INFO BOX FOR MY POSITION
google.maps.event.addListener(e,"click",function(){var e="<strong>You are here!</strong><br>";infoWindow.setContent(e),infoWindow.open(map,this)}),map.setCenter(t);var a={location:t,radius:"50000",keyword:"cat_shelter"};new google.maps.places.PlacesService(map).nearbySearch(a,showPlaces)},function(){handleLocationError(!0,infoWindow,map.getCenter())}):
// BROWSER DO NOT SUPPORT GEOLOCATION
handleLocationError(!1,infoWindow,map.getCenter())}function showPlaces(e,o){if(o==google.maps.places.PlacesServiceStatus.OK)for(var t=0;t<e.length;t++)addMarker(e[t]),console.log(e[t])}function addMarker(e){var o=google.maps.Animation.DROP,t=new google.maps.Marker({map:map,animation:o,position:e.geometry.location,icon:"../src/img/icon.png"});google.maps.event.addListener(t,"click",function(){var o="<strong>"+e.name+"</strong><br>";o+=e.vicinity,infoWindow.setContent(o),infoWindow.open(map,this)})}/* ----------------------------------------------------------------------------
			SCROLL EFFECT
---------------------------------------------------------------------------- */
...
tl.staggerFromTo(eyebrowRight,1,{rotation:0,transformOrigin:"center center"},{rotation:-50,transformOrigin:"center center",yoyo:!0,repeat:1}),tl.staggerFromTo(eyebrowLeft,1,{rotation:0,transformOrigin:"center center"},{rotation:60,transformOrigin:"center center",yoyo:!0,repeat:1})});var currentLocation,infoWindow,links=document.querySelectorAll("h2");links.forEach(function(e){e.addEventListener("click",function(e){var o=e.target.getAttribute("class");e.preventDefault(),history.replaceState(null,null,o),
