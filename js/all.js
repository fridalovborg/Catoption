...
paw.addEventListener("click",function(){tl.fromTo(paw,.3,{scale:1,x:0,y:0},{scale:1.3,x:0,y:-15,yoyo:!0,repeat:1}),tl.fromTo($("#highfiveLines"),.5,{alpha:0},{alpha:1,yoyo:!0,repeat:1}),new Audio("../highfive.mp3").play()}),
