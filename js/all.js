...
function chatbubblePop(){setInterval(function(){tl.fromTo(chatbubble,.7,{alpha:0},{alpha:1,yoyo:!0,repeat:1,repeatDelay:1})},5e3)}/* ----------------------------------------------------------------------------
			SCROLL EFFECT
---------------------------------------------------------------------------- */
...
$("#chatbubbleWhole").css("opacity","0"),$("#semiClosed").css("opacity","0"),$("#eyesClosed").css("opacity","0")}),
...
e.stopPropagation()},!1)}),setInterval(getIGImages,6e4),window.addEventListener("load",getIGImages);/* ----------------------------------------------------------------------------
			FIRST PAGE
---------------------------------------------------------------------------- */
var tl=TweenMax,audioTxt=document.querySelector(".txt"),anim=tl.to(audioTxt,.8,{scaleX:1.2,scaleY:1.2,repeat:-1,yoyo:!0}),icon=document.getElementById("icon");setInterval(function(){$(icon).toggleClass("fa-volume-down fa-volume-up")},800),setTimeout(function(){$("#main-page").show(),$("#load-page").fadeOut(),clearInterval(interval),anim.kill(),$("#show-btn").fadeIn("slow")},4e3);/* ----------------------------------------------------------------------------
			MAP
---------------------------------------------------------------------------- */
